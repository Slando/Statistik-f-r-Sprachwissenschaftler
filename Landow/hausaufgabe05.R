...
#ggplot(data=frauen) + geom_density(aes(color=major,fill=major,x=height),alpha=0.5)
...
# (Keine explizite Antwort nötig, nur eine Überlegung.)
  ...
  # Es fehlt die Gruppe mit dem major "other". Diese hat nur zwei Datenpunkte, 
  # die zudem verhältnismäßig weit auseinander liegen.
