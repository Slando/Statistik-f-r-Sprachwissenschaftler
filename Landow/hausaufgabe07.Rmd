...
3. Wie viele Studenten bekommen weniger als 10 NP?
    ...
    `r (pnorm(10,mean=mu,sd=3, lower.tail=TRUE)*n)` Studenten bekommen weniger als 10 Notenpunkte.

4. Wie viele Studenten bekommen weniger als 8 NP?

    `r (pnorm(8,mean=mu,sd=3, lower.tail=TRUE)*n)` Studenten bekommen weniger als 8 Notenpunkte.
