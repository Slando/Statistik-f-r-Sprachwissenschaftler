% Hausaufgabe 07
% Landow, Steven <phillip.alday@staff.uni-marburg.de>
% 2014-05-09
...
Bei einer Verteilung mit einer SD von 3 befinden sich mehr Studenten im mittleren Bereich, es fallen weniger durch, es erreichen aber auch weniger eine sehr gute Note. Eine Note 1 erhält nur jemand, der eine mehr als überragend gute Leistung erbringt, die außerhalb der SD liegt.
...
Umso mehr Studenten eine gute Note haben, umso mehr fallen durch.

Warum?
Bei einer gleichmäßigen Verteilung ausgehend von 8NP, braucht es nur 4NP weniger, um durchzufallen, jedoch braucht es mindestens 5 NP mehr, um eine sehr gute Note zu erhalten. Somit ist die Fläche unter dem Graphen, links von 5 NP größer, als die Fläche rechts, beginnend mit 13NP.
...
Eine Verteilung mit mehr guten Noten wäre linksschief.
